...
import { N8nWorkflow, N8nConfig, N8nApiResponse, N8nWorkflowsListResponse, N8nTag } from './types.js';
...
export class N8nClient {
  ...
  async setWorkflowTags(workflowId: number, tagIds: string[]): Promise<N8nTag[]> {
